...
export const zhCN: TranslationResources = {
  ...
  common: {
    ...
    states: {
      ...
      starting: "正在开始...",
      copied: "已复制",
      audioBriefPlay: "播放语音简报",
      audioBriefStop: "停止播放",
      audioBriefLoading: "正在生成简报...",
      audioBriefTitle: "语音简报",
  ...
  composer: {
    ...
    quickPrompts: {
      bar: {
        ...
        manageAccessibility: "管理常用语与规则",
      },
      aiSuggestions: {
        title: "AI 智能预测快捷回复",
        hint: "当最新回复没有明确的结构化选项时，使用模型预测下一步操作。",
      },
      modal: {
        title: "常用语与快捷指令",
        newPrompt: "新建常用语",
        ...
        form: {
          ...
          editTitle: "编辑常用语",
          label: "常用语短名称（气泡展示文本）*",
          labelPlaceholder: "例如：修复测试 / 代码审查",
          content: "实际发送的完整提示词 (Prompt)*",
          contentPlaceholder: "例如：请分析上述报错信息，定位根本原因并完成修复...",
          shortcut: "可选斜杠指令（在输入框输入 / 时快速展开）",
          shortcutPlaceholder: "例如：fix（支持输入 /fix 联想替换）",
          triggerType: "触发显示类型",
          triggerFixed: "常驻 (固定在气泡栏)",
          triggerRule: "动态规则 (条件触发)",
          keywords: "上一轮回复包含的关键词（逗号分隔）",
          keywordsPlaceholder: "例如：error, failed, 报错, 失败",
          regex: "上一轮回复匹配的正规表达式（可选）",
          regexPlaceholder: "例如：(y/n)|请确认",
          errorLabelRequired: "请输入常用语标签名称",
          errorContentRequired: "请输入完整提示词内容",
          save: "保存",
          cancel: "取消",
        },
      },
