...
export const ar: TranslationResources = {
  ...
  composer: {
    ...
    quickPrompts: {
      bar: {
        accessibilityHint: "انقر للإرسال، اضغط مطولاً للإدراج في المحرر",
        manageAccessibility: "إدارة المطالبات السريعة والقواعد",
      },
      aiSuggestions: {
        title: "اقتراح ردود سريعة بالذكاء الاصطناعي",
        hint: "عند عدم وجود خيارات واضحة، استخدم الذكاء الاصطناعي لاقتراح الإجراءات التالية.",
      },
      modal: {
        title: "المطالبات السريعة والقواعد",
        newPrompt: "مطالبة سريعة جديدة",
        ...
        delete: "حذف",
        form: {
          createTitle: "مطالبة سريعة جديدة",
          editTitle: "تعديل المطالبة السريعة",
          label: "التسمية",
          labelPlaceholder: "مثال: متابعة، إصلاح الخطأ",
          content: "محتوى المطالبة",
          contentPlaceholder: "المطالبة الكاملة للإرسال أو الإدراج...",
          shortcut: "اختصار أمر الشرطة المائلة (اختياري)",
          shortcutPlaceholder: "مثال: continue (اكتب /continue للاستدعاء)",
          triggerType: "نوع التشغيل",
          triggerFixed: "ثابت (مرئي دائمًا)",
          triggerRule: "قاعدة ديناميكية (مشروطة)",
          keywords: "الكلمات المفتاحية في الرد الأخير (مفصولة بفواصل)",
          keywordsPlaceholder: "مثال: error, failed, exception",
          regex: "تعبير نمطي في الرد الأخير (اختياري)",
          regexPlaceholder: "مثال: (y/n)|proceed\\?",
          errorLabelRequired: "التسمية مطلوبة",
          errorContentRequired: "محتوى المطالبة مطلوب",
          save: "حفظ",
          cancel: "إلغاء",
        },
      },
  ...
  settings: {
    ...
    editor: {
      ...
      quickPrompts: {
        title: "المطالبات السريعة والأوامر",
        hint: "تخصيص البطاقات الثابتة وقواعد الرد الديناميكية والإكمال التلقائي بالأوامر",
        manage: "إدارة",
      },
    },
    notifications: {
    ...
    appearance: {
      ...
      terminalAppearance: {
        title: "مظهر الطرفية",
        description: "تعيين نظام الألوان للطرفية المدمجة",
        accessibilityLabel: "مظهر الطرفية: {{value}}",
        options: {
          "follow-theme": "متابعة مظهر التطبيق",
          pureBlack: "أسود خالص",
          dark: "داكن",
        },
      },
